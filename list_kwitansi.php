...
<style>
  ...
  .app-wrap { max-width: none; width:100%; }
...
.mug-sidebar{width:260px;background:linear-gradient(180deg,#0f172a,#172554);color:#fff;position:fixed;inset:0 auto 0 0;padding:22px 16px;overflow-y:auto;z-index:1000;}
...
@media(max-width:900px){.mug-sidebar{width:78px;padding:20px 10px}.mug-brand-title,.mug-brand-sub,.mug-side-link span,.mug-nav-section{display:none}.mug-side-link{justify-content:center}.mug-main{margin-left:78px;width:calc(100% - 78px);padding:18px}}
...
<main class="mug-main">
<div class="container-fluid app-wrap p-0">
